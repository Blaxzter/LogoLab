...
//
//   node src/devtest/strokeScaleDiag.ts                      # gallery @256 + @512
...
import { loadSource, rasterizeSource, renderSvg } from '../mcp/image.ts'
import { decideInkMode, type ImageDataLike } from '../lib/ink.ts'
import { inkThickness, thicknessAt } from '../lib/strokeWidth.ts'
import { monoTraceScale } from '../lib/traceCaps.ts'
import { DEFAULT_VECTORIZE_OPTIONS, traceImage } from '../lib/trace/index.ts'
import { cropTile, downscaleImageData, toImageData, upscaleImageData } from '../lib/sheet/crop.ts'
import { detectSheetIcons } from '../lib/sheet/detect.ts'
import { repaintDoc } from '../lib/sheet/traceTile.ts'
import { rasterizeDoc } from '../lib/render/raster.ts'
import { fidelity } from '../lib/render/fidelity.ts'
import { docStats } from '../lib/path/model.ts'
