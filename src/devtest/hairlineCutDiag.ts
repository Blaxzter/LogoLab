...
//
//   node src/devtest/hairlineCutDiag.ts --svg a.svg,b.svg [--res 400,499,600,800] [--cuts 128,136,…]
...
import { renderSvg } from '../mcp/image.ts'
import { cutLuma, decideInkMode, VISIBLE_ALPHA, type ImageDataLike } from '../lib/ink.ts'
import { monoTraceScale } from '../lib/traceCaps.ts'
import { DEFAULT_VECTORIZE_OPTIONS, traceImage } from '../lib/trace/index.ts'
import { toImageData, upscaleImageData } from '../lib/sheet/crop.ts'
