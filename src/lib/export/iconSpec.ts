...
export const DEFAULT_TARGETS: ExportTarget[] = [
  ...
  {
    id: 'apple-167',
    label: 'Apple touch 167',
    size: 167,
    fileName: 'apple-touch-icon-167.png',
    maskable: false,
    group: 'apple',
    enabled: false,
  },
  {
    id: 'apple-152',
    label: 'Apple touch 152',
    size: 152,
    fileName: 'apple-touch-icon-152.png',
    maskable: false,
    group: 'apple',
    enabled: false,
  },
  {
    id: 'apple-120',
    label: 'Apple touch 120',
    size: 120,
    fileName: 'apple-touch-icon-120.png',
    maskable: false,
    group: 'apple',
    enabled: false,
  },
  ...
  {
    id: 'windows-150',
    label: 'Windows tile 150',
    size: 150,
    fileName: 'mstile-150.png',
    maskable: false,
    group: 'windows',
    enabled: false,
  },
  {
    id: 'windows-310',
    label: 'Windows tile 310',
    size: 310,
    fileName: 'mstile-310.png',
    maskable: false,
    group: 'windows',
    enabled: false,
  },
