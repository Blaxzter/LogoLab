...
//
//   node --experimental-strip-types bench/apexDiag.ts                    # tier 0
//   node --experimental-strip-types bench/apexDiag.ts --logos            # gallery witnesses
//   node --experimental-strip-types bench/apexDiag.ts --logos all --top 15
//   node --experimental-strip-types bench/apexDiag.ts --res 256,512,1024
//   node --experimental-strip-types bench/apexDiag.ts --case sharp-star --top 30
//
