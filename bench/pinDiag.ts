...
//
//   node --experimental-strip-types bench/pinDiag.ts                 # tier 0
//   node --experimental-strip-types bench/pinDiag.ts --logos         # the gallery slice
//   node --experimental-strip-types bench/pinDiag.ts --logos instagram --top 20
//   node --experimental-strip-types bench/pinDiag.ts --res 256,512,1024
//
