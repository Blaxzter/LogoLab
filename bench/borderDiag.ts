...
//
//   node --experimental-strip-types bench/borderDiag.ts                 # tier-0 fixtures
//   node --max-old-space-size=6144 ... borderDiag.ts --logos                  # the whole gallery
//   node --experimental-strip-types bench/borderDiag.ts --case mastercard --list
//   node --experimental-strip-types bench/borderDiag.ts --gate --logos  # ranked table
