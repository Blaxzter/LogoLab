...
import { decodePng, type DecodedImage } from '../src/lib/png/decode.ts'
import { ensureImageData } from './nodeHarness.ts'
import { downscale } from './traceCorpus.ts'
import { quantize, dropMinorColors } from '../src/lib/trace/quantize.ts'
