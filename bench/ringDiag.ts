...
//
//   node --experimental-strip-types bench/ringDiag.ts                      # olympic-rings
//   node --experimental-strip-types bench/ringDiag.ts --case concentric --res 512
//   node --experimental-strip-types bench/ringDiag.ts olympic-rings.svg --gradients
//   node --experimental-strip-types bench/ringDiag.ts --circles --case ring-cross
//   node --experimental-strip-types bench/ringDiag.ts --circles --corpus   # calibration
//   node --experimental-strip-types bench/ringDiag.ts --families --logos   # §24 sweep census
...
import type { ArcLoopRecord } from '../src/lib/trace/planarBeautify.ts'
