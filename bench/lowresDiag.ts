...
//
//   node --experimental-strip-types bench/lowresDiag.ts [case ...] [--res 256]
//
...
import { traceImage, healColorSpikes, DEFAULT_VECTORIZE_OPTIONS } from '../src/lib/trace/index.ts'
import { quantize, dropMinorColors, modeFilter } from '../src/lib/trace/quantize.ts'
import { tracePlanar } from '../src/lib/trace/planarAssemble.ts'
import { DEFAULT_PLANAR_FIT, FLAT_LINE_COST } from '../src/lib/trace/planarFit.ts'
import { planarBeautify } from '../src/lib/trace/planarBeautify.ts'
import { weldConvergedJunctions } from '../src/lib/trace/planarReseat.ts'
import { materializeRegion, edgeMap } from '../src/lib/path/topology.ts'
import { DEFAULT_BEAUTIFY_OPTIONS } from '../src/lib/trace/beautify.ts'
import type { PaletteColor, QuantizeResult } from '../src/lib/trace/types'
