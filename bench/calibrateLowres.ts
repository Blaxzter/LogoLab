...
//
//   node --experimental-strip-types bench/calibrateLowres.ts            # tier 0 + flute-flat
//   node --experimental-strip-types bench/calibrateLowres.ts --tier2    # sweep all 106 flat twins
//   node --experimental-strip-types bench/calibrateLowres.ts --res 256  # (the default)
//
