...
import { parsePathD, ellipseSubPaths } from '../src/lib/path/model.ts'
import { parseTransformAttr, composeAffine, transformSubPaths } from '../src/lib/path/geometry.ts'
import type { SubPath, PathNode, Affine } from '../src/lib/path/types.ts'
