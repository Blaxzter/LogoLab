...
//
//   node --experimental-strip-types bench/xingDiag.ts                  # olympic-rings @512
//   node --experimental-strip-types bench/xingDiag.ts --case ring-cross --all
//   node --experimental-strip-types bench/xingDiag.ts --scales 256,512,1024,2048
//   node --experimental-strip-types bench/xingDiag.ts --corpus         # exposure sweep
//
...
import { buildPlanarNetwork, EXT, type PlanarNetwork } from '../src/lib/trace/planarNetwork.ts'
import { edgeContrast } from '../src/lib/trace/planarThread.ts'
import { circleMaxDev, fitCircle } from '../src/lib/trace/planarFit.ts'
import { lineFit } from '../src/lib/trace/curveFit.ts'
