...
// iterate on.
//
//   node --experimental-strip-types bench/reseatSelect.ts <cells.json> [--lane NAME] [--min-cross 5]
...
import { intersectPrims, type ReseatPrim } from '../src/lib/trace/planarReseat.ts'
