...
//
//   node --experimental-strip-types bench/subpixelScaleDiag.ts                    # the three coarse-end scale KNOWN_DEFECTS
//   node --experimental-strip-types bench/subpixelScaleDiag.ts overlap --res 256,1024
//   node --experimental-strip-types bench/subpixelScaleDiag.ts band-cross --edges  # per-edge table
//
