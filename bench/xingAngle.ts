...
//
//   node --experimental-strip-types bench/xingAngle.ts            # olympic-rings @512
//   node --experimental-strip-types bench/xingAngle.ts --nochain  # the §24 tracer
//   node --experimental-strip-types bench/xingAngle.ts --res 1024
//
...
import { fitCircle } from '../src/lib/trace/circleFit.ts'
import { reverseEdgeNodes } from '../src/lib/path/topology.ts'
import type { SharedEdge, Vec } from '../src/lib/path/types'
