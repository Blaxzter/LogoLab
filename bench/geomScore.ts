...
import { segmentCount, segmentControls } from '../src/lib/path/geometry.ts'
import { fitCircle, makeCircleSubPath } from '../src/lib/trace/circleFit.ts'
import { rasterizeDoc } from '../src/lib/render/raster.ts'
import { srgbToLab, deltaE76, type Lab } from './color.ts'
import type { SubPath, EditableDoc, Vec } from '../src/lib/path/types.ts'
