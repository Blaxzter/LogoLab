...
//
//   node --experimental-strip-types bench/floorDiag.ts --lane tier2 --res 256,512
//   node --experimental-strip-types bench/floorDiag.ts --lane gallery --res 256,1024 [--limit N] [mark ...]
//   node --experimental-strip-types bench/floorDiag.ts --lane gallery --res 256 ibm fedex-wm --verbose
//
