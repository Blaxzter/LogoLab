...
//
//   node --experimental-strip-types bench/counterDiag.ts --logo instagram --roi 303,112,36,20
//   node --experimental-strip-types bench/counterDiag.ts --svg public/examples/edge-cases/wedge-counter.svg
//   node --experimental-strip-types bench/counterDiag.ts --logo instagram --res 512 --ascii
//
...
import type { PinDiagRecord } from '../src/lib/trace/planarFit.ts'
import type { EditableDoc } from '../src/lib/path/types'
