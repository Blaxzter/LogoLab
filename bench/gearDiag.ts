...
import { traceImage, DEFAULT_VECTORIZE_OPTIONS, healColorSpikes } from '../src/lib/trace/index.ts'
...
import type { PathNode, SubPath, Vec } from '../src/lib/path/types'
