...
//
//   node --experimental-strip-types bench/reseatDiag.ts                      # the fixtures
//   node --experimental-strip-types bench/reseatDiag.ts --case brave-browser --res 512,1024,2048 --verbose
//   node --experimental-strip-types bench/reseatDiag.ts --logos               # gallery sweep
//   node --experimental-strip-types bench/reseatDiag.ts --logos firefox,tiktok
...
import { intersectPrims, type ReseatPrim, type ReseatTune, type ReseatVerdict } from '../src/lib/trace/planarReseat.ts'
