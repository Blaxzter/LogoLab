...
//
//   node --experimental-strip-types bench/softPairDiag.ts --case shaded-ink [--res 512]
//   node --experimental-strip-types bench/softPairDiag.ts examples/logos/ibm.svg
//   node --experimental-strip-types bench/softPairDiag.ts --census [--res 512] [--min 24]
//
...
import { fuseShadingTones } from '../src/lib/trace/shadingFuse.ts'
