...
//
//   node --experimental-strip-types bench/chordDiag.ts                     # the driver case
//   node --experimental-strip-types bench/chordDiag.ts --case overlap --res 256,512,1024,2048
//   node --experimental-strip-types bench/chordDiag.ts --logos [--verbose] # gallery sweep
