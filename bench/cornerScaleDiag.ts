...
//
//   node --experimental-strip-types bench/cornerScaleDiag.ts                      # gear-teeth
//   node --experimental-strip-types bench/cornerScaleDiag.ts --case bar-caps --verbose
//   node --experimental-strip-types bench/cornerScaleDiag.ts --logo chupa-chups --res 512,1024
//   node --experimental-strip-types bench/cornerScaleDiag.ts --logos --res 512,1024      # §15.7's witness hunt
//   node --experimental-strip-types bench/cornerScaleDiag.ts --logos all --res 512,1024
//   node --experimental-strip-types bench/cornerScaleDiag.ts --case gear-teeth --fit cornerMerge=2
//
