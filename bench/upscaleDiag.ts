...
//
//   node --experimental-strip-types bench/upscaleDiag.ts fixtures            # answer-sheet lane
//   node --experimental-strip-types bench/upscaleDiag.ts sheets              # real tiles, 2048 crop = truth
...
import { traceImage, suggestGradients, DEFAULT_VECTORIZE_OPTIONS } from '../src/lib/trace/index.ts'
...
import { detectSheetIcons, cropTile, upscaleImageData, isInkPixel, estimateBackground } from '../src/lib/sheet/index.ts'
import { planTileBase, tileSmoothing } from '../src/lib/sheet/plan.ts'
import type { ImageDataLike, SheetBackground } from '../src/lib/sheet/types.ts'
