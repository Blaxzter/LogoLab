...
//
//   node --experimental-strip-types bench/paintProbe.ts --case letter-joins
//   node --experimental-strip-types bench/paintProbe.ts --ab            # every /labs/ab case, both lanes
//   node --experimental-strip-types bench/paintProbe.ts --ab --lane grad
