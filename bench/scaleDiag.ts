...
//
//   node --experimental-strip-types bench/scaleDiag.ts                    # tier 0
//   node --experimental-strip-types bench/scaleDiag.ts --lattice          # + attribution
//   node --experimental-strip-types bench/scaleDiag.ts --tier2            # the flat twins
//   node --experimental-strip-types bench/scaleDiag.ts --logos            # the 5 witnesses
//   node --experimental-strip-types bench/scaleDiag.ts --logos all        # every fetched mark
//   node --experimental-strip-types bench/scaleDiag.ts --res 256,512,1024,2048
//   node --experimental-strip-types bench/scaleDiag.ts --json out.json    # machine-readable
//
