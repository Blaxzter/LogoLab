...
//
//   node --experimental-strip-types bench/threadScaleDiag.ts                 # band-cross
//   node --experimental-strip-types bench/threadScaleDiag.ts --case seam-corner
//   node --experimental-strip-types bench/threadScaleDiag.ts --res 256,512,1024,2048 --k 2
//
...
import { edgeContrast, surveyJunctions, type JunctionVerdict } from '../src/lib/trace/planarThread.ts'
