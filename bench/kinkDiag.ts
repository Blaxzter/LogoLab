...
//
//   node --experimental-strip-types bench/kinkDiag.ts                 # tier-0 fixtures
//   node --max-old-space-size=6144 ... kinkDiag.ts --logos                  # the whole gallery
//   node --experimental-strip-types bench/kinkDiag.ts --case chupa-chups --list
...
//   node --experimental-strip-types bench/kinkDiag.ts --gate
